...
const limiter = RateLimit({
    store: new RedisStore({
        client: redisClient,
        expiry: 24*60*60*1000 //removes key in secods from redis (24 hours)
    }),
    max: 5, // maximum count of request in given duration windowMs here
    windowMs: 24*60*60*1000, // duration for rate limit  ... 5 requests in 24 hours   << 15*60*1000, // 15 minutes >>
